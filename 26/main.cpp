...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("D:/Project/OpenGL/Lab4/Lab4/Content/box.obj")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "D:/Project/OpenGL/Lab4/Lab4/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "D:/Project/OpenGL/Lab4/Lab4/Content/normal_map.jpg");

        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "D:/Project/OpenGL/Lab4/Lab4/Content/normal_up.jpg");
