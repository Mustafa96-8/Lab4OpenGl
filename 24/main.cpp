...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("D:/Project/OpenGL/Lab4/Lab4/Content/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "D:/Project/OpenGL/Lab4/Lab4/Content/test.png");
        ...
        return m_pMesh->LoadMesh("D:/Project/OpenGL/Lab4/Lab4/Content/phoenix_ugv.md2");
    }
